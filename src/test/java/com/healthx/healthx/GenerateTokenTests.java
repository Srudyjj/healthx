...
import com.healthx.model.ClientGrantType;
...
class GenerateTokenTests {
    ...
    void generateTokenInvalidClientTest() throws Exception {
        ...
        when(clientRepository.findByClientId("client"))
    ...
    void generateRefreshTokenTest() throws Exception {
        ...
        client.setClientId("client");
        client.setSecret("secret");
        client.addGrantType(gt1);
        client.addGrantType(gt2);
        client.setScope("read");
